...
export const TYPES = {
  HOME: ["", __("Help")],
  VALUE_SOURCE_OPTIONS: ["/user-guide/querying/query-parameters#Value-Source-Options", __("Guide: Value Source Options")],
  SHARE_DASHBOARD: ["/user-guide/dashboards/sharing-dashboards", __("Guide: Sharing and Embedding Dashboards")],
  ...
  DS_URL: ["/data-sources/querying-urls", __("Guide: Help Setting up URL")],
  DS_MONGODB: ["/data-sources/mongodb-setup", __("Guide: Help Setting up MongoDB")],
  DS_GOOGLE_SPREADSHEETS: ["/data-sources/querying-a-google-spreadsheet", __("Guide: Help Setting up Google Spreadsheets")],
  DS_GOOGLE_ANALYTICS: ["/data-sources/google-analytics-setup", __("Guide: Help Setting up Google Analytics")],
  DS_AXIBASETSD: ["/data-sources/axibase-time-series-database", __("Guide: Help Setting up Axibase Time Series")],
  DS_RESULTS: ["/user-guide/querying/query-results-data-source", __("Guide: Help Setting up Query Results")],
  ALERT_SETUP: ["/user-guide/alerts/setting-up-an-alert", __("Guide: Setting Up a New Alert")],
  MAIL_CONFIG: ["/open-source/setup/#Mail-Configuration", __("Guide: Mail Configuration")],
  ALERT_NOTIF_TEMPLATE_GUIDE: ["/user-guide/alerts/custom-alert-notifications", __("Guide: Custom Alerts Notifications")],
  FAVORITES: ["/user-guide/querying/favorites-tagging/#Favorites", __("Guide: Favorites")],
  MANAGE_PERMISSIONS: [
    "/user-guide/querying/writing-queries#Managing-Query-Permissions",
    __("Guide: Managing Query Permissions"),
  ],
  NUMBER_FORMAT_SPECS: ["/user-guide/visualizations/formatting-numbers", __("Formatting Numbers")],
};
